...
> 2. Se o artefato exibir alguma checagem já feita — um teste que passou, um lint limpo, uma saída colada —, não se contente em repeti-la. Ela passou por construção, porque quem a escolheu sabia que passaria. Rode a checagem que ninguém escolheu.
...
> 6. **Monte a sua própria lista de alegações antes de julgar qualquer coisa.** Leia o PEDIDO ORIGINAL e o ARTEFATO e escreva que afirmações de fato esse artefato sustenta. Essa lista é sua e é a única que existe — o dossiê não traz lista nenhuma, de propósito: uma lista escrita por quem está sendo auditado delimitaria o seu olhar sem precisar mentir uma vírgula. Se a sua lista sair curta, o problema é dela, não do artefato; releia o pedido e procure o que o artefato promete sem dizer.
> 7. Ataque prioritariamente, nesta ordem: o que o PEDIDO ORIGINAL exigia e você não encontra no artefato; a afirmação em que mais coisa se apoia, porque é a que custa mais caro se for falsa; alegações cujo predicado plausível seria mais estreito que a alegação (contar linhas não prova "nada perdido", rodar um caso não prova "funciona"); efeitos colaterais que o artefato não menciona.
>
